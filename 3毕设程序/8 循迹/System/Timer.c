...
void Timer_Init(void)
{
	...
	NVIC_InitStructure.NVIC_IRQChannelSubPriority=1; //指定IRQ通道的子优先级
...
/*
void TIM2_IRQHandler(void) //检查是否设置了指定的TIM标志
{
  if(TIM_GetITStatus(TIM2,TIM_IT_Update)==SET)//检查TIM中断是否发生
  {

   TIM_ClearITPendingBit(TIM2,TIM_IT_Update); //清除TIMx的中断挂起位
  }
}
*/
